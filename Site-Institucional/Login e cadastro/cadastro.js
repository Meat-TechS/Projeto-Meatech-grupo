 function cadastrar() {
        ...
        let razao = input_razaoSocial.value
        let nome = input_nomeFantasia.value
        ...
        if (razao === '') {
            valido = false
           document.getElementById('razao-required-error').style.display = "block";
        } else{
             document.getElementById('razao-required-error').style.display = "none";
        }
        ...
        if (cep === '') {
            valido = false
           document.getElementById('cep-required-error').style.display = "block";
        } else {
            document.getElementById('cep-required-error').style.display = "none";
            if (cep.length != 8) {
                valido = false
                document.getElementById('cep-invalid-error').style.display = "block";
            }else{
                document.getElementById('cep-invalid-error').style.display = "none";
            }
        }
        ...
        if (numero === '') {
            valido = false
            document.getElementById('numero-required-error').style.display = "block";
        } else{
            document.getElementById('numero-required-error').style.display = "none";
        }
